package com.aamsystems.licencemanager;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public SpnegoAuthenticationProcessingFilter spnegoAuthenticationProcessingFilter() {
        ...
        try {
            ...
            System.out.println("Failed to set AuthenticationManager on SpnegoAuthenticationProcessingFilter." + e.getMessage());
        }
        return filter;
    }
    ...
    public SunJaasKerberosTicketValidator sunJaasKerberosTicketValidator() {
        ...
        System.out.println("Initializing Kerberos KEYTAB file path:" + fs.getFilename() + " for principal: " + servicePrincipal + "file exist: " + fs.exists());
